...
// tout en restant distinct du AppHeader Particulier via la nav tabs
// et l'accent ambré.
...
export const ProShell = ({
  ...
  return (
    <div className="min-h-dvh bg-slate-50 flex flex-col">
      <header
        className="sticky top-0 z-40 bg-[#0E3B2E] text-white border-b border-amber-500/30"
          ...
          <div className="flex items-center gap-1">
            {showCart && (
              ...
              >
                ...
                {count > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 rounded-full bg-amber-500 text-[#0E3B2E] text-[10px] font-bold flex items-center justify-center border border-[#0E3B2E]">
                    {count > 99 ? "99+" : count}
                  </span>
                )}
              </button>

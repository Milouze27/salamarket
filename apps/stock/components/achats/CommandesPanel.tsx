...
/* CommandesPanel — liste des bons de commande fournisseurs
 * ───────────────────────────────────────────────────────
 * Extrait de /v2/po (dashboard PO) pour vivre comme onglet « Commandes »
 * de la page Achats. Header/BackButton/V2Shell retirés (fournis par la
 * page hôte). Toute la logique métier est conservée : fetch PO + joins,
 * régénération algo, envoi (server action), badges certif halal, drawer,
 * filtres par statut. Les liens vers /v2/po/[id] passent par le PoDrawer.
 */
    ...
    <>
      ...
      <div className="flex items-center gap-3 mb-5 flex-wrap">
        ...
        <Link
          ...
          style={{ minHeight: 44 }}
        >
          <Building2 size={16} /> Bons de réception
        </Link>
      </div>
